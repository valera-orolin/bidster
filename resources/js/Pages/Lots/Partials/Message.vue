...
<template>
    <div v-if="message.is_current" class="flex flex-col space-y-1 justify-self-end my-8">
    ...
    <div v-else class="flex flex-col space-y-1 justify-start items-start my-8">
        <div class="px-6 py-4 max-w-3xl bg-my-gray2 rounded-tl-xl rounded-tr-xl rounded-br-xl flex flex-col items-end">
            <div v-if="message.is_seller" class="self-start space-y-3">
                <span class="my-gradient-text font-semibold">{{ message.name }}</span> 
