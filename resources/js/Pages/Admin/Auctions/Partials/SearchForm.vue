    ...
    <form>
        <div class="md:px-32 p-4 md:pt-16 text-my-gray4">
            ...
            <div class="flex justify-between flex-wrap">
                ...
                <div class="flex flex-col md:flex-row space-y-1 md:space-y-0 md:space-x-6 items-start md:items-center mt-3">
                    <p>Status</p>
                    <select id="category" required class="w-64 p-5 rounded-full transition duration-500 bg-my-black border-my-black focus:border-my-black focus:outline-none focus:ring-0.5 focus:ring-my-black">
